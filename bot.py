...
# ── 2b. Enable universe + multiverse repos (idempotent — safe to run every time)
# This ensures any container — even ones built from an older image — can
# install any package from the full Ubuntu catalogue via apt.
...
if command -v add-apt-repository >/dev/null 2>&1; then
    ...
    # Fallback: directly edit sources.list to uncomment universe/multiverse
